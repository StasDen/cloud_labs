...
CREATE SCHEMA IF NOT EXISTS party_animators-database DEFAULT CHARACTER SET utf8;
USE
party_animators-database;
...
(
    ...
    UNIQUE INDEX phone_number_UNIQUE
(
    phone_number ASC
) VISIBLE,
    INDEX fk_client_client_card1_idx
(
    client_card_id ASC
) VISIBLE)
    ENGINE = InnoDB;
...
(
    ...
    INDEX fk_entertainment_agency_animator1_idx
(
    animator_id ASC
) VISIBLE,
    INDEX fk_entertainment_agency_city1_idx
(
    city_id ASC
) VISIBLE)
    ENGINE = InnoDB;
...
(
    ...
    INDEX fk_order_event1_idx
(
    event_id ASC
) VISIBLE,
    INDEX fk_order_discount1_idx
(
    discount_id ASC
) VISIBLE,
    INDEX fk_order_client1_idx
(
    client_id ASC
) VISIBLE,
    INDEX fk_order_entertainment_agency1_idx
(
    entertainment_agency_id ASC
) VISIBLE)
    ENGINE = InnoDB;
...
(
    ...
    INDEX fk_agency_worker_entertainment_agency1_idx
(
    entertainment_agency_id ASC
) VISIBLE)
    ENGINE = InnoDB;
...
VALUES (1, "Birthday", 2, 15, "2022-08-11", "Stepana  Bandery St", 3, 1),
       ...
       (7, "Son's Birthday", 1, 30, "2022-07-16", "Prorizna St", 3, 3),
       (8, "Mother's Birthday", 1, 15, "2022-08-03", "Zelena St", 5, 2),
...
VALUES (1, "Birthday", 400, 1, 6, 5, 1),
       ...
       (6, "Mother's Birthday", 400, 8, NULL, 3, 3),
